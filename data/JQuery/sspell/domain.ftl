<!-- START Domain Table -->
<#if (pcvar("DOMAIN.1") > 0) >
		<div class="ssp-table"><table width="100%" cellspacing="0" cellpadding="3" summary="Domain List">
			<tr>
...
<@loop from=1 to=pcvar('COUNT[DOMAINS]+1') ; domainspell , domainspell_has_next >
